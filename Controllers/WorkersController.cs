...
namespace Personnel_Service.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public WorkersController(Personnel_ServiceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,RoomId,FirstName,LastName")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoomId,FirstName,LastName,Nationality")] Worker worker)
        {
            if (id != worker.Id)
            {
                return NotFound();
